/**
 * itemGroup.js
 * @description :: sequelize model of database table itemGroup
 */
...
let ItemGroup = sequelize.define('itemgroup', {
  id: {
    type: DataTypes.UUID,
...
sequelizeTransforms(ItemGroup);
sequelizePaginate.paginate(ItemGroup);
