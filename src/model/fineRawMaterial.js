...
let FineRawMaterial = sequelize.define('finerawmaterial', {
  id: {
    type: DataTypes.UUID,
  ...
  materialName: { type: DataTypes.STRING },
...
sequelizeTransforms(FineRawMaterial);
sequelizePaginate.paginate(FineRawMaterial);
module.exports = FineRawMaterial;
