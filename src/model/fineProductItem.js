...
let FineProductItem = sequelize.define('fineproductitem', {
  id: {
    type: DataTypes.UUID,
  ...
  measurement: { type: DataTypes.STRING },
  ingredientCost: { type: DataTypes.STRING },
  costPerg: { type: DataTypes.STRING },
...
sequelizeTransforms(FineProductItem);
sequelizePaginate.paginate(FineProductItem);
module.exports = FineProductItem;
