...
let RawMaterialProduct = sequelize.define('rawMaterialProduct', {
  id: {
    type: DataTypes.UUID,
...
sequelizeTransforms(RawMaterialProduct);
sequelizePaginate.paginate(RawMaterialProduct);
module.exports = RawMaterialProduct;
