...
/**
 * Create a logging utility for controller functions.
 * @param {string} functionName - The name of the controller function.
 * @param {string} message - The log message.
 * @param {number} status - The HTTP status code.
 * @param {Object} req - The request object.
 * @returns {Object} - An object with info, error, and debug methods for logging.
 */
const logController = (functionName, message, status, req) => {
  /**
   * Log message based on the provided log type.
   * @param {string} logType - The type of log (info, error, debug).
   */
  const log = (logType) => logger[logType](`${functionName}: ${message}`, {
    status,
    parameters: req.body,
